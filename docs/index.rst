...
playing games. Adding a new game to the system is a fairly straightforward
process. Clients do not have to be tied to this project in any way, and can be
independently developed and implemented using whatever strategies are desired.
StratumGS can be deployed for any group, from a small group of friends to a
company (although at this stage in development, the number of users the system
can handle may be limited).
...
StratumGS is licensed under the
